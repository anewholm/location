...
use AcornAssociated\Location\Models\Lookup;
use AcornAssociated\Location\Models\Settings;
use AcornAssociated\Location\Controllers\Lookups;
...
<?php Block::put('breadcrumb') ?>
    <ul>
        <li><a href="<?= Backend::url('acornassociated/location/locations') ?>">Location</a></li>
            ...
            <div id="location-lookup" class="<?= $google_address_lookup_class ?>">
                <div class="layout-row">
                    <?php if (!$google_maps_key) print($this->makeHintPartial('no_api_key', array(
                        'type'  => 'warning',
                        'title' => trans('acornassociated.location::lang.plugin.api_key_required'),
                        'icon'  => 'icon-warning'
                    ))); ?>
                    <?php
                        $lookup  = new Lookup();
        ...
        <div id="location-create" class="<?= $google_address_lookup_class ?>">
            ...
            <div class="form-buttons">
                <div class="loading-indicator-container">
                    ...
                    <span class="btn-text">
                        <?= e(trans('backend::lang.form.or')) ?> <a href="<?= Backend::url('acornassociated/location/locations') ?>"><?= e(trans('backend::lang.form.cancel')) ?></a>
                    </span>
                </div>
            </div>
        </div>
...
<?php else: ?>
    ...
    <p><a href="<?= Backend::url('acornassociated/location/locations') ?>" class="btn btn-default"><?= e(trans('backend::lang.form.return_to_list')) ?></a></p>
<?php endif ?>
