        ...
        <div class="form-buttons">
            <div class="loading-indicator-container">
                <button
                    ...
                    data-load-indicator="<?= e(trans('backend::lang.form.saving_name', ['name' => trans('acornassociated.location::lang.models.gps.label')])); ?>"
                ...
                <button
                    ...
                    data-load-indicator="<?= e(trans('backend::lang.form.deleting_name', ['name' => trans('acornassociated.location::lang.models.gps.label')])); ?>"
